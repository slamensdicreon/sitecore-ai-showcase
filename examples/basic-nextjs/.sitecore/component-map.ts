...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['Column Splitter', { ...ColumnSplitter }],
  ['SiteHeader', { ...SiteHeader }],
  ['Site Header', { ...SiteHeader }],
  ['SiteFooter', { ...SiteFooter }],
  ['Site Footer', { ...SiteFooter }],
  ['PartialDesignDynamicPlaceholder', { ...PartialDesignDynamicPlaceholder }],
  ['Partial Design Dynamic Placeholder', { ...PartialDesignDynamicPlaceholder }],
  ['PartialDesign Dynamic Placeholder', { ...PartialDesignDynamicPlaceholder }],
  ['ContainerFullWidth', { ...ContainerFullWidth }],
  ['Container Full Width', { ...ContainerFullWidth }],
  ['ContainerFullBleed', { ...ContainerFullBleed }],
  ['Container Full Bleed', { ...ContainerFullBleed }],
