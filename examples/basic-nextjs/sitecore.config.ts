...
const parseIntSafe = (value: string | undefined, fallback?: number): number | undefined => {
...
export default defineConfig({
  ...
  personalize: {
    ...
    edgeTimeout: parseIntSafe(process.env.PERSONALIZE_MIDDLEWARE_EDGE_TIMEOUT),
    cdpTimeout: parseIntSafe(process.env.PERSONALIZE_MIDDLEWARE_EDGE_TIMEOUT),
  },
});
