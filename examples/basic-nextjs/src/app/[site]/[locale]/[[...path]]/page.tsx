...
import { SiteInfo, Page } from "@sitecore-content-sdk/nextjs";
...
export default async function Page({ params, searchParams }: PageProps) {
  ...
  return (
    <NextIntlClientProvider>
      <Providers page={activePage as Page} componentProps={componentProps}>
        <Layout page={activePage as Page} routePath={routePath} />
      </Providers>
    </NextIntlClientProvider>
  );
}
